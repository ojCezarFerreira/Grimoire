...
**[Required Reading]**
Before proceeding, read `${CLAUDE_PLUGIN_ROOT}/GRIMOIRE-CONVENTIONS.md`. Its rules (§ TDD, § Sub-agent spawning, § Commits, § .grimoire/ layout, § Pause-point pattern) are load-bearing for this skill.
